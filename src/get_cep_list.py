...
def carregar_lista_cep(
    ...
    try:
        ...
        # O random_state garante que a amostra seja a mesma em execuções
        # diferentes. A escolha do 25 por padrão foi por causa da soma dos
        # dígitos do ano de fundação do banco (1 + 9 + 6 + 9 = 25).
