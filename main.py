...
from src.data_transformation import normalizar_resultados, validar_dados_transformados
...
with ThreadPoolExecutor(max_workers=workers) as executor:
    ...
    lista_cep = carregar_lista_cep(tamanho_amostra=20)
    ...
    resultados_ok = normalizar_resultados(resultados_ok)
    resultados_ok = validar_dados_transformados(resultados_ok)
